...
## [0.11.1](https://github.com/kogisin/rig/compare/rig-core-v0.11.0...rig-core-v0.11.1) - 2025-04-09

### Added

- AWS Bedrock provider ([#318](https://github.com/kogisin/rig/pull/318))

### Fixed

- deserialization error due to serde rename of tool result ([#374](https://github.com/kogisin/rig/pull/374))

### Other

- Fix Clippy warnings for doc indentation and Error::other usage ([#364](https://github.com/kogisin/rig/pull/364))
